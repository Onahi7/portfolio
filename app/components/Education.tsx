...
export default function Education() {
  const education = [
    {
      degree: "Bachelor's of Technology in Applied Mathematics",
      institution: "Federal University of Technology Minna",
      period: "2015 – 2019",
      achievements: [
        "Specialized in mathematical modeling and computational methods",
        "Completed projects applying mathematical concepts to real-world problems",
        "Participated in mathematics and programming competitions",
      ],
    },
  ]
  ...
  return (
    <section
      id="education"
      className="py-20 bg-gradient-to-br from-blue-50 to-slate-50 dark:from-gray-900 dark:to-slate-900 transition-colors duration-300 overflow-hidden relative"
    >
